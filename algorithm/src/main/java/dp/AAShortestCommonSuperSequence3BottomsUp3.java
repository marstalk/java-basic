 ...
 * 输出："aaaaaaaa"
 */
public class AAShortestCommonSuperSequence3BottomsUp3 {
    public static void main(String[] args) {
        AAShortestCommonSuperSequence3BottomsUp3 hShortestCommonSuperSequence1 = new AAShortestCommonSuperSequence3BottomsUp3();
    ...
    public String scss(String str1, String str2) {
        ...
        // init
        for (int i = 0; i < m + 1; i++) {
            dp[i][0] = new Info(i + 1, new StringBuilder(str1.substring(0, i)));
        }
        for (int j = 0; j < n + 1; j++) {
            dp[0][j] = new Info(j + 1, new StringBuilder(str2.substring(0, j)));
        }
