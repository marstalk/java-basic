 ...
 * 输出："aaaaaaaa"
 */
public class AAShortestCommonSuperSequence2Memo {
    public static void main(String[] args) {
        AAShortestCommonSuperSequence2Memo hShortestCommonSuperSequence1 = new AAShortestCommonSuperSequence2Memo();
